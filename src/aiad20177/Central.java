			...
			public void action() {
				...
				case 1:
					...
					if (msg != null) {
						...
						AskTaxi inform = new AskTaxi(receive.getPassengerID(), receive.getCurrentX(),
								receive.getCurrentY(), receive.getFinalX(), receive.getFinalY());
				...
				case 2:
					...
					if (msg3 != null) {
						...
						CentralPassenger informPassenger = new CentralPassenger(receive2.getTaxiID(), receive2.getTaxiID(),
								receive2.getVacancy());
						...
						System.out.println("Central is informing passenger "+receive2.getPassengerID()+"that Taxi "+receive2.getTaxiID()+" is on route to pick him up");
						//msg4 = blockingReceive();
						msg4.addReceiver(new AID("Passenger"+receive2.getPassengerID(), AID.ISLOCALNAME));
						send(msg4);
					}else
					break;
				}
